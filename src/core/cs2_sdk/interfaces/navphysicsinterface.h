...
class INavPhysicsInterface
{
  private:
    ...
    virtual void Nav_TraceLine(const Vector& vStart,
                               const Vector& vEnd,
                               CBaseEntity* pIgnore,
    ...
    virtual void Nav_TraceShape(const Ray_t& ray,
                                const Vector& vStart,
                                const Vector& vEnd,
                                CBaseEntity* pIgnore,
                                uint64 nInteractsWith,
    ...
    virtual bool
    Nav_CheckAreaOverlappingEntity(/*CNavArea*/ const void* const rArea, const CBaseEntity* const rEntity, bool bExtrudeHullHeight) = 0;
  ...
  public:
    static void TraceLine(const Vector& vStart,
                          const Vector& vEnd,
                          CBaseEntity* pIgnore,
                          uint64 nInteractsWith,
                          uint8 nCollisionGroup,
    ...
    static void TraceShape(const Ray_t& ray,
                           const Vector& vStart,
                           const Vector& vEnd,
                           CBaseEntity* pIgnore,
                           uint64 nInteractsWith,
