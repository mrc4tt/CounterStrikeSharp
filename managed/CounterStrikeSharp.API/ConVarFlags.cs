...
namespace CounterStrikeSharp.API
{
    ...
    public enum ConVarFlags : Int64
    {
        ...
        FCVAR_SNAPSHOT_IGNORED = (1 << 30), // TakeConVarSnapshot and ResetConVarsToSnapshot ignore cvars with this flag set
        FCVAR_DEFENSIVE = (1L << 32),
        FCVAR_GAMEINFO_CANNOT_OVERRIDE = (1L << 34), // Code defaults can't be overridden from gameinfo
    }
